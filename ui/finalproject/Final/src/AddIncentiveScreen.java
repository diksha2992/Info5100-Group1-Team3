...
public class AddIncentiveScreen extends JFrame {
    ...
    private void applyButtonMouseClicked(MouseEvent e) {
        try {
        	...
        	sb.append(i.getDiscount()+"\n");
        	sb.append(i.getDescription()+"\n");
        	sb.append(i.getDisclaimer()+"\n");
        	String incentive=sb.toString();
        	HandleInfo h=new HandleInfo();
        	HandleInfo.addToFile("incentiveDetails.txt", incentive);
            //idm.add(i);
        } catch (Exception ex) {
    ...
    public Incentive GetIncentive() throws Exception {
        Incentive i = new Incentive();
        //please set i's attribute.
