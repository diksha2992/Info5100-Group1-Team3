...
public class Incentive extends JFrame implements Comparable<Incentive> {
	private String ID;
    ...
    //EditIncentiveScreen
    private void EditIncentives(Incentive i) {
    ...
    private void showIncentive(Incentive i) {
    ...
    private void applyButtonClicked(MouseEvent e, String str) {
    	try {
    		if(str.equals("edit")) {
    			/*Option one*/
//    			updateAIncentive(getTextFromEditScreen());           //call updateAIncentive in IncentiveImple.java   			
    			/*Option two
    			delete(getTextFromEditScreen().getID());             //when click on apply button, delete old incentive in the file
    			fw.writeAIncentiveToFile(getTextFromEditScreen());     //then write new incentive to file
    			*/
    		}else if(str.equals("add")) {
    			fw.writeAIncentiveToFile(getTextFromAddScreen());
    		}	
	...
	private Incentive getTextFromEditScreen() throws Exception {
...
//        	i.setDealerId(d.getDealerId);// dealerid is in dealerScreen
    ...
    private Incentive getTextFromAddScreen() throws Exception {
		Incentive i = new Incentive();
		StringBuilder errorMessage = new StringBuilder();
